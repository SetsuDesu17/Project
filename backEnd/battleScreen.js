...
const battleScreen = {
    ...
    battleStart: () => {
        let [player, enemy, stringArray, intArray, playerSkillsArray] = battleScreen.initiateBattle(); // Generate player and enemy entities, and pre-battle resources such as skill arrays and argument arrays
        ...
        while (battleStatus === "continue" && newTurn === true) { // Turn Handler
            ...
            // Get All Planning Phase Output
            [ player, enemy, stringArray, intArray, playerSkillsArray, playerPlan, enemyPlan ] = battleSystem.planningPhase(player, enemy, stringArray, intArray, playerSkillsArray);
            ...
            // [ player, enemy, stringArray, intArray, playerSkillsArray ] = battleSystem.attackPhase(turnOrder[0], player, enemy, stringArray, playerSkillsArray, intArray, playerPlan, enemyPlan);
    ...
    initiateBattle: () => {
        ...
        // Entity Structure: [   id,  type,     name, level,exp,hp,atk,def,spd,status]
        const player = new entity(0, "Player", "Setsu", 1, 0, 100, 20, 10, 15, null);
